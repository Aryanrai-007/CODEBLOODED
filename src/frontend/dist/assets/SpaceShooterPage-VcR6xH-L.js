import { u as useNavigate, a as useGameAuth, r as reactExports, b as useSubmitGameScore, c as useTopScores, d as usePlayerRank, e as useGamePlayers, j as jsxRuntimeExports, A as ArrowLeft, T as Trophy, H as Heart, Z as Zap, X } from "./index-Dkj3zGm_.js";
...
function addParticles(g, x, y, color, n = 14) {
  for (let i = 0; i < n; i++) {
...
function SpaceShooterPage() {
  ...
  const { data: playerRank } = usePlayerRank(GAME_ID, currentPlayer == null ? void 0 : currentPlayer.playerId);
  ...
  reactExports.useEffect(() => {
    ...
    function loop(ts) {
      ...
      for (const b of g.bullets) {
        ...
        b.x += b.vx * dt;
        b.y += b.vy * dt;
        if (b.life !== void 0) b.life -= dt;
      }
      g.bullets = g.bullets.filter(
        (b) => b.y > -30 && b.y < H + 30 && b.x > -30 && b.x < W + 30 && (b.life === void 0 || b.life > 0)
      );
      for (const e of g.enemies) {
        if (e.type === "boss") {
          e.x += e.xDir * 1.5 * dt;
      ...
      for (const b of g.bullets) {
        ...
        for (const e of g.enemies) {
          ...
          if (!overlap(
            ...
            continue;
          if (b.life === void 0) toRemoveBullets.add(b.id);
          e.hp -= b.dmg;
      ...
      ctx.save();
      const sx = g.screenShake > 0 ? (Math.random() - 0.5) * Math.min(g.screenShake, 8) : 0;
      ...
      const drawPlayer = g.invTimer <= 0 || Math.floor(g.invTimer / 8) % 2 === 0;
      if (drawPlayer) {
        ctx.save();
        ctx.shadowColor = "#06b6d4";
        ctx.shadowBlur = 18;
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-0.5", children: HEART_KEYS.map((k, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                        Heart,
                        {
                          className: "w-4 h-4",
                          style: {
              ...
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 flex-wrap justify-center mt-2", children: [
                    !submitted && currentPlayer && /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "button",
                      {
                        type: "button",
          ...
          showLb && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                !topScores || topScores.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-mono", style: { color: "#374151" }, children: "No scores yet" }) : topScores.map((s, i) => {
                  const isMe = (currentPlayer == null ? void 0 : currentPlayer.playerId) === s.playerId;
                  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "div",
                            {
                              ...
                              children: playerMap[s.playerId] ?? s.playerId.slice(0, 8)
                            }
                          ),
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "div",
