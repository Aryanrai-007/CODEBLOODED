...
export function SpaceShooterGame({
  ...
  // startLoop: cancel any pending frame, capture loopRef.current BEFORE rAF call
      ...
      <div className="flex gap-3 w-full max-w-3xl items-start">
        ...
        <div className="relative flex-1">
          ...
          {gameOver && (
            ...
            >
              ...
              {/* Void Striker High Scores in game-over */}
              ...
              {/* Grand Arena Rankings in game-over */}
        ...
        {showLb && (
          ...
          >
            ...
            {/* Grand Arena Ranking section */}
            <div
              className="mt-3 pt-3"
              style={{ borderTop: "1px solid rgba(168,85,247,0.2)" }}
            >
              <div className="flex items-center gap-1 mb-2">
                <Trophy className="w-3 h-3" style={{ color: "#a855f7" }} />
                <span
                  className="text-xs font-bold tracking-widest font-mono"
                  style={{ color: "#a855f7" }}
                >
